import java.util.*;
  ...
  public class PiBot implements RoShamBot {
    ...
    static ArrayList<Integer> pi_table = new ArrayList<Integer>(Arrays.asList(3,1,4,1,5,9,2,6,5,3,5,8,9,7,9,3,2,3,8,4,6,2,6,4,3,3,8,3,2,7,9,5,0,2,8,8,4,1,9,7,
